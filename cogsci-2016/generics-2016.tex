...
In the current paper, we synthesize these previous findings under a single explanation, arguing that generic interpretations are driven by a failure to find reference for entities or events described by the sentence in question. This claim explains why particular morphosyntactic and contextual features all play a large role in guiding generic interpretation. We also build on empirical work described by \citeA{Gelman:2003} and \citeA{Cimpian:2008} by assessing the impact of these factors on adults' judgments about genericity across a wide variety of sentences.
