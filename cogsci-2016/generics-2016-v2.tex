...
\mcf{Can you discuss why number didn't work?}
...
The results of the classification task described above suggest that tense plays a critical role in guiding judgments as to whether a sentence should be interpreted as generic. In order to confirm this finding, we \mcf{FIXME}
...
Outstanding issue: What about other languages? \mcf{could say this is a limitation?}
