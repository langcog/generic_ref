...
function make_explanation(subject, rating){
	...
	if (subject == 'mouse' && rating == 0){
		...
		explanation = "You should have said that this sentence was about swords. It expresses a generalization about swords, rather than saying anything about any specific swords. Click the button below one more time to continue."
	}
		...
		explanation = "You should have said that this sentence was about zebras. It expresses a fact about zebras in general, rather than any specific group of zebras. Click the button below one more time to continue." 
	}
		...
		explanation = "You should have said that this sentence was about elephants. It expresses a fact about elephants in general, rather than any specific group of elephants. Click the button below one more time to continue." 
	}
